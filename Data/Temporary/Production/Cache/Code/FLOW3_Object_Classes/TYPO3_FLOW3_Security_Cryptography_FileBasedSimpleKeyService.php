 ...
 */
class FileBasedSimpleKeyService extends FileBasedSimpleKeyService_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Security\Cryptography\FileBasedSimpleKeyService') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Cryptography\FileBasedSimpleKeyService', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Cryptography\FileBasedSimpleKeyService');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Cryptography\FileBasedSimpleKeyService', $propertyName, 'transient')) continue;
