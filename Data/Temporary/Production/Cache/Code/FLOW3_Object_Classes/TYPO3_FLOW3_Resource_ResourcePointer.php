	...
	public function __construct() {
		...
		call_user_func_array('parent::__construct', $arguments);
				...
				if (array_key_exists(0, $arguments)) $methodArguments['hash'] = $arguments[0];
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Resource\ResourcePointer', '__construct', $joinPoint->getMethodArguments());
	 ...
	 public function __clone() {
		...
		$result = NULL;
			...
			try {
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Resource\ResourcePointer', '__clone', $joinPoint->getMethodArguments(), NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
