 ...
 * </output>
 */
class LinkViewHelper extends LinkViewHelper_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\ViewHelpers\Widget\LinkViewHelper', $propertyName, 'transient')) continue;
