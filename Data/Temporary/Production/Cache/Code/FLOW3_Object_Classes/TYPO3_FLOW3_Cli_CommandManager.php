...
class CommandManager extends CommandManager_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Cli\CommandManager') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Cli\CommandManager', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cli\CommandManager');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cli\CommandManager', $propertyName, 'transient')) continue;
