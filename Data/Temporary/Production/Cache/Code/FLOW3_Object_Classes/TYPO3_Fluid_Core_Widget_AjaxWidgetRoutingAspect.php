 ...
 */
class AjaxWidgetRoutingAspect extends AjaxWidgetRoutingAspect_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\Fluid\Core\Widget\AjaxWidgetRoutingAspect') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\Fluid\Core\Widget\AjaxWidgetRoutingAspect', $this);
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->ajaxWidgetContextHolder = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\Fluid\Core\Widget\AjaxWidgetContextHolder');
	}
}
#