 ...
 */
class DateTimeRangeValidator extends DateTimeRangeValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\DateTimeRangeValidator');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\DateTimeRangeValidator', $propertyName, 'transient')) continue;
