 ...
 */
class InternalRequestEngine extends InternalRequestEngine_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Http\Client\InternalRequestEngine') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Http\Client\InternalRequestEngine', $this);
		if (get_class($this) === 'TYPO3\FLOW3\Http\Client\InternalRequestEngine') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Http\Client\RequestEngineInterface', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Http\Client\InternalRequestEngine');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Http\Client\InternalRequestEngine', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		...
		$this->dispatcher = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Mvc\Dispatcher');
		$this->router = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Mvc\Routing\Router');
