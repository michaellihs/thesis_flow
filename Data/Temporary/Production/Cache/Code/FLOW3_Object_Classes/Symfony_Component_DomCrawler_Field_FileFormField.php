 ...
 */
class FileFormField extends FileFormField_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\DomCrawler\Field\FileFormField');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\DomCrawler\Field\FileFormField', $propertyName, 'transient')) continue;
