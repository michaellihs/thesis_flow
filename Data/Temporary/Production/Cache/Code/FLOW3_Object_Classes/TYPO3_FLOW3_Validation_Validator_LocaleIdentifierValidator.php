 ...
 */
class LocaleIdentifierValidator extends LocaleIdentifierValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Validation\Validator\LocaleIdentifierValidator') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Validation\Validator\LocaleIdentifierValidator', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\LocaleIdentifierValidator');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\LocaleIdentifierValidator', $propertyName, 'transient')) continue;
