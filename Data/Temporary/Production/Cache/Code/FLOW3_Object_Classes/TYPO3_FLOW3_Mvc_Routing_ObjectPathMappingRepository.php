...
class ObjectPathMappingRepository extends ObjectPathMappingRepository_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Mvc\Routing\ObjectPathMappingRepository') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Mvc\Routing\ObjectPathMappingRepository', $this);
		parent::__construct();
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Mvc\Routing\ObjectPathMappingRepository');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Mvc\Routing\ObjectPathMappingRepository', $propertyName, 'transient')) continue;
