	 ...
	 */
	 public function decideOnJoinPoint(\TYPO3\FLOW3\Aop\JoinPointInterface $joinPoint) {
		...
		try {
				...
				$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Authorization\AccessDecisionVoterManager', 'decideOnJoinPoint', $joinPoint->getMethodArguments(), NULL, NULL, $exception);
