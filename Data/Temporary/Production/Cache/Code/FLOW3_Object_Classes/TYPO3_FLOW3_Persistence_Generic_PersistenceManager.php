		...
		$result = parent::getObjectByIdentifier($identifier, $objectType, $useLazyLoading);
			...
			try {
				...
				$methodArguments['useLazyLoading'] = $useLazyLoading;
					...
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Generic\PersistenceManager', 'getObjectByIdentifier', $methodArguments, $adviceChain);
	 ...
	 protected function emitAllObjectsPersisted() {
		...
		$result = parent::emitAllObjectsPersisted();
			...
			try {
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Generic\PersistenceManager', 'emitAllObjectsPersisted', $joinPoint->getMethodArguments(), NULL, $result);
