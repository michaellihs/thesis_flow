 ...
 * 
 */
class FormFieldRegistry extends FormFieldRegistry_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\DomCrawler\FormFieldRegistry');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\DomCrawler\FormFieldRegistry', $propertyName, 'transient')) continue;
