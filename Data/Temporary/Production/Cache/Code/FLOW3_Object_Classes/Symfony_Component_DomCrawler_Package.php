...
class Package extends Package_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'Symfony\Component\DomCrawler\Package') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('Symfony\Component\DomCrawler\Package', $this);

		if (!isset($arguments[2])) $arguments[2] = 'Classes/';
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\DomCrawler\Package');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\DomCrawler\Package', $propertyName, 'transient')) continue;
