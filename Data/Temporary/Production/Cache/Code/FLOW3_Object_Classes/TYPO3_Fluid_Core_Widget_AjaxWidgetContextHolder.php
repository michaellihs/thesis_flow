		...
		$result = parent::store($widgetContext);
			...
			try {
				...
				$methodArguments['widgetContext'] = $widgetContext;
					...
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\Fluid\Core\Widget\AjaxWidgetContextHolder', 'store', $joinPoint->getMethodArguments(), $adviceChain);
		...
		$result = parent::get($ajaxWidgetId);
			...
			try {
				...
				$methodArguments['ajaxWidgetId'] = $ajaxWidgetId;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\Fluid\Core\Widget\AjaxWidgetContextHolder', 'get', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
