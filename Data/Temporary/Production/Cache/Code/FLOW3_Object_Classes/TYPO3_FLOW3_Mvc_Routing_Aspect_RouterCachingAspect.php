...
class RouterCachingAspect extends RouterCachingAspect_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\FLOW3\Mvc\Routing\Aspect\RouterCachingAspect') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Mvc\Routing\Aspect\RouterCachingAspect', $this);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Mvc\Routing\Aspect\RouterCachingAspect');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Mvc\Routing\Aspect\RouterCachingAspect', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectFindMatchResultsCache(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Cache\CacheManager')->getCache('FLOW3_Mvc_Routing_FindMatchResults'));
		$this->injectResolveCache(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Cache\CacheManager')->getCache('FLOW3_Mvc_Routing_Resolve'));
	}
}
#