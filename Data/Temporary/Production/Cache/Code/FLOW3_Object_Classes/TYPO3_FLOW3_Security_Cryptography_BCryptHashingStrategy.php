 ...
 */
class BCryptHashingStrategy extends BCryptHashingStrategy_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'TYPO3\FLOW3\Security\Cryptography\BCryptHashingStrategy') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\FLOW3\Security\Cryptography\BCryptHashingStrategy', $this);

		if (!isset($arguments[0])) $arguments[0] = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->getSettingsByPath(explode('.', 'TYPO3.FLOW3.security.cryptography.BCryptHashingStrategy.cost'));
		if (!isset($arguments[0])) throw new \TYPO3\FLOW3\Object\Exception\UnresolvedDependenciesException('Missing required constructor argument $cost in class ' . __CLASS__ . '. Please check your calling code and Dependency Injection configuration.', 1296143787);
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Cryptography\BCryptHashingStrategy');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Cryptography\BCryptHashingStrategy', $propertyName, 'transient')) continue;
