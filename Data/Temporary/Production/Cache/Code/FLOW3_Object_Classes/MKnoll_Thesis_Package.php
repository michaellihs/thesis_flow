...
class Package extends Package_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (get_class($this) === 'MKnoll\Thesis\Package') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('MKnoll\Thesis\Package', $this);
	...
	$reflectedClass = new \ReflectionClass('MKnoll\Thesis\Package');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('MKnoll\Thesis\Package', $propertyName, 'transient')) continue;
