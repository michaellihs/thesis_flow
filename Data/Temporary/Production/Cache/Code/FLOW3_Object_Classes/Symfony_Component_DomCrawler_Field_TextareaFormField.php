 ...
 */
class TextareaFormField extends TextareaFormField_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\DomCrawler\Field\TextareaFormField');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\DomCrawler\Field\TextareaFormField', $propertyName, 'transient')) continue;
