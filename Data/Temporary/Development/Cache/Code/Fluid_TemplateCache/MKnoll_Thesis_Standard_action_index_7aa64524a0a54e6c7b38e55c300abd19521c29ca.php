<?php
class FluidCache_MKnoll_Thesis_Standard_action_index_7aa64524a0a54e6c7b38e55c300abd19521c29ca extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
        ...
        $(function() {
            ...
            $( "#searchPhraseAutoComplete" ).autocomplete({
                source: function( request, response ) {
                    $.ajax({
                        url: "http://thesis.localhost/mknoll.thesis/standard/autocomplete",
                        dataType: "json",
                        data: {
                            phrase: request.term
                        },
