		...
		$this->FLOW3_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
			'execute' => array(
				'TYPO3\FLOW3\Aop\Advice\AroundAdvice' => array(
					new \TYPO3\FLOW3\Aop\Advice\AroundAdvice('TYPO3\FLOW3\Security\Aspect\PersistenceQueryRewritingAspect', 'rewriteQomQuery', $objectManager, NULL),
				),
			),
			'count' => array(
				'TYPO3\FLOW3\Aop\Advice\AroundAdvice' => array(
	 ...
	 public function execute() {
		...
		$result = parent::execute();
			...
			try {
					...
					$adviceChains = $this->FLOW3_Aop_Proxy_getAdviceChains('execute');
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Doctrine\Query', 'execute', $methodArguments, $adviceChain);
	 ...
	 public function count() {
		...
		$result = parent::count();
			...
			try {
					...
					$adviceChains = $this->FLOW3_Aop_Proxy_getAdviceChains('count');
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Doctrine\Query', 'count', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
