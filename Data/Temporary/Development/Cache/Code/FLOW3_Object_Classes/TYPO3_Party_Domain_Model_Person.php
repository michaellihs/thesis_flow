	...
	public function __construct() {
		...
		parent::__construct();
				...
				try {
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\Party\Domain\Model\Person', '__construct', $joinPoint->getMethodArguments());
	 ...
	 public function __clone() {
		...
		$result = NULL;
			...
			try {
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\Party\Domain\Model\Person', '__clone', $joinPoint->getMethodArguments());
					$result = $this->FLOW3_Aop_Proxy_invokeJoinPoint($joinPoint);

					$advices = $this->FLOW3_Aop_Proxy_targetMethodsAndGroupedAdvices['__clone']['TYPO3\FLOW3\Aop\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\Party\Domain\Model\Person', '__clone', $joinPoint->getMethodArguments(), NULL, $result);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
