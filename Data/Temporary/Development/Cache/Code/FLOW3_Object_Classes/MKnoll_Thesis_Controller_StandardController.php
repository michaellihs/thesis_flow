...
class StandardController extends StandardController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'MKnoll\Thesis\Controller\StandardController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('MKnoll\Thesis\Controller\StandardController', $this);
	...
	$reflectedClass = new \ReflectionClass('MKnoll\Thesis\Controller\StandardController');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('MKnoll\Thesis\Controller\StandardController', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectSettings(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Configuration\ConfigurationManager')->getConfiguration(\TYPO3\FLOW3\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'MKnoll.Thesis'));
