 ...
 */
class Link extends Link_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (!isset($arguments[2])) $arguments[2] = 'GET';
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\DomCrawler\Link');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\DomCrawler\Link', $propertyName, 'transient')) continue;
