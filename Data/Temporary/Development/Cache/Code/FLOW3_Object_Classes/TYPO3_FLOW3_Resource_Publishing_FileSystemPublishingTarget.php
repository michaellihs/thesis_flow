		...
		$result = parent::buildPersistentResourceWebUri($resource);
			...
			try {
				...
				$methodArguments['resource'] = $resource;
					...
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Resource\Publishing\FileSystemPublishingTarget', 'buildPersistentResourceWebUri', $methodArguments, $adviceChain);
		...
		$result = parent::buildPersistentResourcePublishPathAndFilename($resource, $returnFilename);
			...
			try {
				...
				$methodArguments['returnFilename'] = $returnFilename;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Resource\Publishing\FileSystemPublishingTarget', 'buildPersistentResourcePublishPathAndFilename', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 */
	 public function unpublishPersistentResource(\TYPO3\FLOW3\Resource\Resource $resource) {
		...
		try {
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Resource\Publishing\FileSystemPublishingTarget', 'unpublishPersistentResource', $joinPoint->getMethodArguments(), NULL, $result);
				...
				if (!$afterAdviceInvoked) {
					$advices = $this->FLOW3_Aop_Proxy_targetMethodsAndGroupedAdvices['unpublishPersistentResource']['TYPO3\FLOW3\Aop\Advice\AfterAdvice'];
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Resource\Publishing\FileSystemPublishingTarget', 'unpublishPersistentResource', $joinPoint->getMethodArguments(), NULL, NULL, $exception);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				}
