	 ...
	 public function execute() {
		...
		$result = parent::execute();
			...
			try {
					...
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Generic\Query', 'execute', $methodArguments, $adviceChain);
	 ...
	 public function count() {
		...
		$result = parent::count();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Persistence\Generic\Query', 'count', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
