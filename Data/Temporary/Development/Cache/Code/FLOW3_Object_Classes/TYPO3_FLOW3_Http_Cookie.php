 ...
 */
class Cookie extends Cookie_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (!isset($arguments[6])) $arguments[6] = true;
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Http\Cookie');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Http\Cookie', $propertyName, 'transient')) continue;
