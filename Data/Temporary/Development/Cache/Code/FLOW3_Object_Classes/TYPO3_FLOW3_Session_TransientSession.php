	 ...
	 */
	 public function start() {
		...
		try {
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'start', $joinPoint->getMethodArguments(), NULL, $result);
				...
				if (!$afterAdviceInvoked) {
					$advices = $this->FLOW3_Aop_Proxy_targetMethodsAndGroupedAdvices['start']['TYPO3\FLOW3\Aop\Advice\AfterAdvice'];
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'start', $joinPoint->getMethodArguments(), NULL, NULL, $exception);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				}
	 ...
	 */
	 public function resume() {
		...
		try {
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'resume', $joinPoint->getMethodArguments(), NULL, $result);
					$afterAdviceInvoked = TRUE;
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				...
				if (!$afterAdviceInvoked) {
					$advices = $this->FLOW3_Aop_Proxy_targetMethodsAndGroupedAdvices['resume']['TYPO3\FLOW3\Aop\Advice\AfterAdvice'];
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'resume', $joinPoint->getMethodArguments(), NULL, NULL, $exception);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				}
		...
		$result = parent::destroy($reason);
			...
			try {
				...
				$methodArguments['reason'] = $reason;
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'destroy', $joinPoint->getMethodArguments());
					$result = $this->FLOW3_Aop_Proxy_invokeJoinPoint($joinPoint);
	 ...
	 public function renewId() {
		...
		$result = parent::renewId();
			...
			try {
					...
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Session\TransientSession', 'renewId', $methodArguments, $adviceChain);
