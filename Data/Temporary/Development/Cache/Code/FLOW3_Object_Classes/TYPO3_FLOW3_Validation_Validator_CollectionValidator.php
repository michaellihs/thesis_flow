 ...
 */
class CollectionValidator extends CollectionValidator_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Validation\Validator\CollectionValidator');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Validation\Validator\CollectionValidator', $propertyName, 'transient')) continue;
