...
class ControllerContext extends ControllerContext_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if (!isset($arguments[1])) $arguments[1] = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Http\Response');
		if (!isset($arguments[2])) $arguments[2] = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Mvc\Controller\Arguments');
		if (!isset($arguments[3])) $arguments[3] = \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Mvc\Routing\UriBuilder');
