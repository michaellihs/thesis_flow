...
class Context extends Context_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	 ...
	 */
	 public function setInterceptedRequest(\TYPO3\FLOW3\Mvc\ActionRequest $interceptedRequest = NULL) {
		...
		$result = parent::setInterceptedRequest($interceptedRequest);
			...
			try {
				...
				$methodArguments['interceptedRequest'] = $interceptedRequest;
					...
					$advices = $this->FLOW3_Aop_Proxy_targetMethodsAndGroupedAdvices['setInterceptedRequest']['TYPO3\FLOW3\Aop\Advice\BeforeAdvice'];
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'setInterceptedRequest', $methodArguments);
					...
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'setInterceptedRequest', $joinPoint->getMethodArguments(), $adviceChain);
	 ...
	 public function initialize() {
		...
		$result = parent::initialize();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'initialize', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function isInitialized() {
		...
		$result = parent::isInitialized();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'isInitialized', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function getAuthenticationStrategy() {
		...
		$result = parent::getAuthenticationStrategy();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getAuthenticationStrategy', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function getAuthenticationTokens() {
		...
		$result = parent::getAuthenticationTokens();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getAuthenticationTokens', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
		...
		$result = parent::getAuthenticationTokensOfType($className);
			...
			try {
				...
				$methodArguments['className'] = $className;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getAuthenticationTokensOfType', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function getRoles() {
		...
		$result = parent::getRoles();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getRoles', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 */
	 public function hasRole($roleName) {
		...
		$result = parent::hasRole($roleName);
			...
			try {
				...
				$methodArguments['roleName'] = $roleName;
			
					$adviceChains = $this->FLOW3_Aop_Proxy_getAdviceChains('hasRole');
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'hasRole', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function getParty() {
		...
		$result = parent::getParty();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getParty', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
		...
		$result = parent::getPartyByType($className);
			...
			try {
				...
				$methodArguments['className'] = $className;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getPartyByType', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function getAccount() {
		...
		$result = parent::getAccount();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getAccount', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
		...
		$result = parent::getAccountByAuthenticationProviderName($authenticationProviderName);
			...
			try {
				...
				$methodArguments['authenticationProviderName'] = $authenticationProviderName;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getAccountByAuthenticationProviderName', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function getCsrfProtectionToken() {
		...
		$result = parent::getCsrfProtectionToken();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getCsrfProtectionToken', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function hasCsrfProtectionTokens() {
		...
		$result = parent::hasCsrfProtectionTokens();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'hasCsrfProtectionTokens', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
		...
		$result = parent::isCsrfProtectionTokenValid($csrfToken);
			...
			try {
				...
				$methodArguments['csrfToken'] = $csrfToken;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'isCsrfProtectionTokenValid', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function getInterceptedRequest() {
		...
		$result = parent::getInterceptedRequest();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'getInterceptedRequest', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function clearContext() {
		...
		$result = parent::clearContext();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'clearContext', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 protected function separateActiveAndInactiveTokens() {
		...
		$result = parent::separateActiveAndInactiveTokens();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'separateActiveAndInactiveTokens', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
		...
		$result = parent::mergeTokens($managerTokens, $sessionTokens);
			...
			try {
				...
				$methodArguments['sessionTokens'] = $sessionTokens;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'mergeTokens', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
		...
		$result = parent::updateTokens($tokens);
			...
			try {
				...
				$methodArguments['tokens'] = $tokens;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'updateTokens', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
	 ...
	 public function refreshTokens() {
		...
		$result = parent::refreshTokens();
			...
			try {
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Security\Context', 'refreshTokens', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
