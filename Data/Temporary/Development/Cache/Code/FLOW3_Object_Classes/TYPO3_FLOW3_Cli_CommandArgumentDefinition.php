...
class CommandArgumentDefinition extends CommandArgumentDefinition_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Cli\CommandArgumentDefinition');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Cli\CommandArgumentDefinition', $propertyName, 'transient')) continue;
