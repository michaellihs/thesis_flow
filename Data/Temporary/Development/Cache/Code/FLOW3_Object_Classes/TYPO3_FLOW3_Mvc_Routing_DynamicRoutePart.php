...
class DynamicRoutePart extends DynamicRoutePart_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Mvc\Routing\DynamicRoutePart');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Mvc\Routing\DynamicRoutePart', $propertyName, 'transient')) continue;
