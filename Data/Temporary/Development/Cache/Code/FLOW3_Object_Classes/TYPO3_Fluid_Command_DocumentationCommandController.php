 ...
 */
class DocumentationCommandController extends DocumentationCommandController_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if (get_class($this) === 'TYPO3\Fluid\Command\DocumentationCommandController') \TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->setInstance('TYPO3\Fluid\Command\DocumentationCommandController', $this);
		parent::__construct();
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\Fluid\Command\DocumentationCommandController', $propertyName, 'transient')) continue;
