 ...
 */
class PasswordToken extends PasswordToken_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Security\Authentication\Token\PasswordToken');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Security\Authentication\Token\PasswordToken', $propertyName, 'transient')) continue;
