 ...
 */
class ActionRequest extends ActionRequest_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Mvc\ActionRequest');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Mvc\ActionRequest', $propertyName, 'transient')) continue;
