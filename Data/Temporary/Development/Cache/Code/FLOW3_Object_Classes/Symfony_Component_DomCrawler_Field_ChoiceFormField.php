 ...
 */
class ChoiceFormField extends ChoiceFormField_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
	...
	$reflectedClass = new \ReflectionClass('Symfony\Component\DomCrawler\Field\ChoiceFormField');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('Symfony\Component\DomCrawler\Field\ChoiceFormField', $propertyName, 'transient')) continue;
