		...
		$result = parent::addMessage($message);
			...
			try {
				...
				$methodArguments['message'] = $message;
					...
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Mvc\FlashMessageContainer', 'addMessage', $joinPoint->getMethodArguments(), $adviceChain);
		...
		$result = parent::flush($severity);
			...
			try {
				...
				$methodArguments['severity'] = $severity;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Mvc\FlashMessageContainer', 'flush', $joinPoint->getMethodArguments(), $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
		...
		$result = parent::getMessages($severity);
			...
			try {
				...
				$methodArguments['severity'] = $severity;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Mvc\FlashMessageContainer', 'getMessages', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
		...
		$result = parent::getMessagesAndFlush($severity);
			...
			try {
				...
				$methodArguments['severity'] = $severity;
					...
					$adviceChain = $adviceChains['TYPO3\FLOW3\Aop\Advice\AroundAdvice'];
					$adviceChain->rewind();
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Mvc\FlashMessageContainer', 'getMessagesAndFlush', $methodArguments, $adviceChain);
					$result = $adviceChain->proceed($joinPoint);
