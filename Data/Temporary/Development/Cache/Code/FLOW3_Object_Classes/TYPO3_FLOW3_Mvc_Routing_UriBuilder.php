...
class UriBuilder extends UriBuilder_Original implements \TYPO3\FLOW3\Object\Proxy\ProxyInterface {
		...
		$result = parent::build($arguments);
			...
			try {
				...
				$methodArguments['arguments'] = $arguments;
					...
					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Mvc\Routing\UriBuilder', 'build', $methodArguments);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}

					$joinPoint = new \TYPO3\FLOW3\Aop\JoinPoint($this, 'TYPO3\FLOW3\Mvc\Routing\UriBuilder', 'build', $joinPoint->getMethodArguments());
	...
	$reflectedClass = new \ReflectionClass('TYPO3\FLOW3\Mvc\Routing\UriBuilder');
	...
	foreach ($allReflectedProperties as $reflectionProperty) {
		...
		if ($reflectionService->isPropertyTaggedWith('TYPO3\FLOW3\Mvc\Routing\UriBuilder', $propertyName, 'transient')) continue;
	 ...
	 */
	 private function FLOW3_Proxy_injectProperties() {
		$this->injectRouter(\TYPO3\FLOW3\Core\Bootstrap::$staticObjectManager->get('TYPO3\FLOW3\Mvc\Routing\RouterInterface'));
